...
(function() {
    ...
    // Make it obvious to the user that they need to enter a username and some details
    document.getElementById('apollo-employee-login').value = '⚠️⚠️⚠️ENTER A USERNAME⚠️⚠️⚠️'
    document.getElementById('audit_properties_After observing the AA, have a conversation with them about behaviors observed.  Please list below the conversation key points (both positive and negative)').value = '⚠️⚠️⚠️ENTER SOME DETAILS⚠️⚠️⚠️'
